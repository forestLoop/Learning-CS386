...
tra_label_dir = "TD_FixMaps/"

image_ext = ".png"
label_ext = ".png"

model_dir = os.path.join(os.getcwd(), "saved_models", "cs386", model_name + os.sep)
...
for img_path in tra_img_name_list:
    ...
    tra_lbl_name_list.append(data_dir + tra_label_dir + imidx + "_s" + label_ext)
